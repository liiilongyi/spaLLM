...
def main():
    ...
    # Load data
    file_fold = 'D:/lilongyi/SpatialGlue/dataset/Data_SpatialGlue/Dataset2_Mouse_Spleen2/'
    ...
    # UMAP visualization
    save_umap_visualization(adata, 'D:/lilongyi/SpatialGlue/dataset/benchmark/Spleen/umap.jpeg')

    # Save violin plots
    save_violin_plot(adata, 'alpha_att1', 'embedding_spa vs omic',
                     'D:/lilongyi/SpatialGlue/dataset/benchmark/Spleen/alpha_att1.jpeg')
    save_violin_plot(adata, 'alpha_att2', 'embedding_fea vs omic',
                     'D:/lilongyi/SpatialGlue/dataset/benchmark/Spleen/alpha_att2.jpeg')
